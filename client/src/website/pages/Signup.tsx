  ...
  return (
    <FormWrapper onSubmit={handleSubmit(onSubmit)}>
      ...
      <div tw=" flex mb-3 pb-5 justify-center ">
        <button
          type="submit"
          tw="py-3  focus:outline-none w-40 text-white text-center bg-indigo-600 hover:bg-indigo-500 rounded-full  disabled:opacity-50"  >
           {
            false ? <PulseLoader color="#fff"  /> : <p>Sign Up</p> 
          }
        </button>
      </div>
